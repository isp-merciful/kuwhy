...
export default function ConfirmLeaveDialog({
  ...
  description = "You will leave this party note and stop receiving new messages. You can join again later if there is space.",
        ...
        >
          ...
          >
            ...
            <div className="mt-6 flex justify-end gap-3">
              ...
              <button
                onClick={onConfirm}
                className="inline-flex items-center justify-center rounded-lg bg-amber-500 px-4 py-2 text-sm font-semibold text-white hover:bg-amber-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-amber-500 disabled:opacity-50"
                disabled={busy}
              >
                {confirmText}
              </button>
