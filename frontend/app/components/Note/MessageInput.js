...
export default function MessageInput({
  ...
  return (
    <div className="relative">
      ...
      <div
        onClick={() => {
          if (isPosted) setShowPopup(true);
        }}
        className={`relative rounded-2xl px-4 py-3 shadow-md max-w-xs w-auto flex flex-col items-center justify-center transition-all duration-200 cursor-pointer
