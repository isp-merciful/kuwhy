export default function AboutUsPage() {
  return (
    <main className="w-full">
      ...
      {/* CTA */}
      <section className="py-20 bg-gradient-to-br from-blue-600 via-green-600 to-teal-600">
        <div className="mx-auto max-w-7xl px-6">
          <div className="rounded-3xl p-12 sm:p-16 shadow-2xl relative overflow-hidden bg-white/10 backdrop-blur-sm">
            ...
            <div className="relative z-10 text-center">
              <h3 className="text-3xl sm:text-4xl font-bold text-white mb-6">Join the KU WHY Community</h3>
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a href="/" className="inline-flex items-center justify-center rounded-full border-2 border-white text-white font-semibold px-8 py-4 hover:bg-white hover:text-blue-600 transition-all duration-300">
                  Back to Home
                </a>
              </div>
            </div>
